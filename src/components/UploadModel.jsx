...
const UploadModel = ({ uploadAndTranscribe, setShowModel, file, handleOnChangeFormData, formData }) => {
            ...
            <div className="bg-bg-light md:min-h-[270px] md:min-w-[500px] p-5 rounded-xl ">
                ...
                <div className='flex flex-col my-2 gap-1 p-2'>
                    ...
                    <span className='w-full flex flex-col p-2 gap-5'>
                        ...
                        <button onClick={uploadAndTranscribe} className='text-center md:px-5 md:py-3 w-full h-14
